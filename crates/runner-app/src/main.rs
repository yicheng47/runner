...
struct NativeRoot {
    ...
    chat_panel_resizing: bool,
    resizing_split: Option<String>,
    ...
    sidebar_preview_trigger_hovered: bool,
    sidebar_preview_dwell: u64,
    sidebar_preview_dwell_generation: u64,
...
impl NativeRoot {
    ...
    /// that label a session by what it says it is doing (#587).
    pub(crate) fn attached_title(&self, session_id: &str, cx: &App) -> Option<String> {
        self.app_store
            .read(cx)
            .bridge
            .session(session_id)
    ...
    pub(crate) fn attached_titles(&self, cx: &App) -> HashMap<String, String> {
        self.attached
            .iter()
            .map(|(id, chat)| (id.clone(), chat.terminal.title()))
            .chain(self.app_store.read(cx).bridge.titles())
            .collect()
    }
    ...
    fn new(
        ...
        let mut root = Self {
            ...
            sidebar_preview_trigger_hovered: false,
            sidebar_preview_dwell: 0,
            sidebar_preview_dwell_generation: 0,
