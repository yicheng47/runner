...
- [`554-mcp-project-management.md`](./554-mcp-project-management.md) — feature [554](../features/554-mcp-project-management.md): `project_create` / `project_rename` / `project_delete` / `mission_set_project` MCP tools over the existing sidebar ops.
