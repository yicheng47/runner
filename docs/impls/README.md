...
- [`570-split-tree-and-icon.md`](./570-split-tree-and-icon.md) — feature [570](../features/570-split-panes-redesign.md), PR 2: the layout persists as a tree, one `columns-2` split icon per pane opens Split Right / Split Down for that pane, a 240 × 160 px size floor replaces the pane count, the preset picker goes.
...
- [Split panes, PR 1](./archive/570-split-panes-redesign.md) — feature [570](../features/570-split-panes-redesign.md), shipped 2026-09-12 in [#571](https://github.com/yicheng47/runner/pull/571): no focus border, unfocused pane bodies at 70 % opacity, the chat glyph on the identity line and header. PR 2 (tree, split icon, picker removal) follows.
