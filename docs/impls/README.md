...
- [`493-windows-auto-update.md`](./493-windows-auto-update.md) — feature [493](../features/493-windows-auto-update.md): signed installer assets, the Inno Setup handoff, the Windows updater core, and the update dialog, in three reviewed phases.
