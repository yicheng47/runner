...
| 2 | Spec phases 4–5: the UI copy table and the two modal fixes, `surfaces/runners/` → `surfaces/roles/`, the user-facing backend strings, vision, arch, AGENTS.md, both READMEs. | codex peer, [brief](../archive/gpui-rewrite/briefs/604-m2-role-rename-ui-docs.md) | Briefed 2026-09-16 on `feat/604-m1-backend` from `2c54b7c` |
