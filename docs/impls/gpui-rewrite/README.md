...
- [m6-consolidation.md](m6-consolidation.md) — M6 plan: real input-state tracking first (M6.1), then hook-based session status, post-audit defects, and structural debt, with the `main`-first landing rule.
