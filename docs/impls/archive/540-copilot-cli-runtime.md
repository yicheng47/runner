...
Plan for feature [540](../../features/archive/540-copilot-cli-runtime.md) ([#540](https://github.com/yicheng47/runner/issues/540)). The spec carries the per-surface inventory and the probe evidence; this file is the mission sequence and what has landed.
