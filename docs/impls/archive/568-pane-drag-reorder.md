...
5. **Docs.** `docs/arch/arch.md:201`: one sentence — a pane moves within the tree by drag, keeps its id, split ids continue the counter. `docs/tests/archive/64-terminal-as-pane-option-smoke.md` §4: two checkboxes for the grip and a drop.
