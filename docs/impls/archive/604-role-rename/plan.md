...
| follow-up | `runner_status` → `session_status` with read compatibility across the CLI, runner-core's `KnownSignalType`, the app and mission-watch. | inline | After both missions |
