...
>
> Companion to `docs/arch/arch.md` (architecture), `docs/product/vision.md` (scope), and `docs/journals/v0-mvp.md` (dated implementation log). This file is the stable MVP implementation reference.
