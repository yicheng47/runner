...
>
> Companion to `docs/arch/arch.md` (architecture), `docs/product/vision.md` (scope), and `docs/journals/archive/v0-mvp.md` (dated implementation log). This file is the stable MVP implementation reference.

## Status snapshot

For dated implementation history and validation notes, see `docs/journals/archive/v0-mvp.md`.
...
items are tracked in `docs/journals/archive/v0-mvp.md`.
