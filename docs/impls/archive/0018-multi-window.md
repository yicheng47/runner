...
In progress for issue [#122](https://github.com/yicheng47/runner/issues/122). Implements feature spec [docs/features/archive/12-multi-window.md](../../features/archive/12-multi-window.md).
