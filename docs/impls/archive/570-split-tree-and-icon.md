...
5. **Docs.** `docs/arch` wherever it describes the preset picker or the persisted layout shape; `docs/tests/archive/64-terminal-as-pane-option-smoke.md` lines that mention the picker. The spec is archived at landing, not by the crew.
