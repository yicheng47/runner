...
- Docs: `docs/arch/arch.md:199` ("Splits hold chats only…"), `docs/tests/archive/64-terminal-as-pane-option-smoke.md:23` and §4, `docs/features/archive/570-split-panes-redesign.md:32`.
