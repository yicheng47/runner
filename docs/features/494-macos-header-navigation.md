...
Tracking issue: [#494](https://github.com/yicheng47/runner/issues/494). Status: planned. Priority P2.
...
- Match the Windows buttons' visual treatment and **Previous page** / **Next page** tooltips. Adapt placement to the macOS traffic lights and titlebar spacing.
...
1. Record the macOS placement in a feature-scoped Pencil design, covering sidebar expanded/collapsed and fullscreen states.
...
- Previous/next icons appear in the macOS header with the same order, styling, and tooltips as Windows.
