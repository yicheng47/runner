...
- [593 — Provider icons for chats](./593-provider-chat-icons.md) — Claude's orange starburst and the OpenAI knot for Codex across chat identity surfaces, with bundled assets and light/dark support; references Orca and cmux ([#593](https://github.com/yicheng47/runner/issues/593), P2).
...
- [587 — Display terminal-provided titles](./587-terminal-provided-titles.md) — show child-supplied OSC 0/2 titles in pane and tab labels on macOS and Windows, with explicit user names taking precedence; live title text stays separate from activity detection and routing ([#587](https://github.com/yicheng47/runner/issues/587), P1; design frame `x3miq` in `design/runner.pen`).
