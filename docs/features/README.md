...
- [590 — Runtime model discovery and cache](./590-runtime-model-discovery.md) — cmux-style discovery for Codex and Claude Code, with persistent last-good catalogs, ten-minute background refresh, shared queries, silent offline/failure behavior, success logging, and native Windows verification; TRAE keeps its current behavior ([#590](https://github.com/yicheng47/runner/issues/590), P2; initial implementation [#591](https://github.com/yicheng47/runner/pull/591)).
