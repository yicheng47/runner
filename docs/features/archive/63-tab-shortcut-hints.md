...
Status: shipped in v0.6.1 (2026-08-23, PR #435 → `a9cd866`; design `design/runner.pen` `cmp/TabShortcutPill` `gpQTy`, frame `BOqhO`). Program slot: M6.15 in [m6-remainder.md](../../impls/archive/gpui-rewrite/m6-remainder.md).
