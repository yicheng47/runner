...
4. **Interaction: reuse the layout picker**, not drag-tab-to-edge. Direct chat shipped the picker; use the same one to choose how many runner sessions to show side by side. Drag-to-reshape remains out of scope.
