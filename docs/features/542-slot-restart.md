...
- `crates/runner-app/src/ui/session_control.rs`: the Restart kind (muted icon at rest, danger tint when pressed).
...
- Stop all from the header: the confirm names the slot count; Cancel leaves everything running.
