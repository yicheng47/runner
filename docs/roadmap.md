...
- **In flight:** the general `runner` CLI ([spec](./features/648-runner-cli.md), [plan](./impls/648-runner-cli.md)), mission 1 briefed on branch `feat/648-runner-cli`. The missions-as-containers spec ([`features/562-mission-spawn.md`](./features/562-mission-spawn.md)) is written and waits for 0.12.
...
| [#648](https://github.com/yicheng47/runner/issues/648) general `runner` CLI | P1 | Spec and command set designed; [plan](./impls/648-runner-cli.md) written, five missions, mission 1 briefed and not started |
